...
# import time_api
from bigscreen.time_api import *
from bigscreen.account_window import *
...
class App(tk.CTk):
    def __init__(self, *args, **kwargs):
        ...
        self.city1 = tk.CTkLabel(self.pointed_minidate, text = f"{city}", font = ("Roboto Slab", 12), bg_color = "transparent", height=1)
        ...
        self.account_button = tk.CTkButton(self.content_up, width=50, height=40, text="",command=go_to_account)
        ...
        # self.image_label = tk.CTkLabel(self.account_button, image=self.image,fg_color="#5DA7B1", text='123')
        ...
        self.content_middle = tk.CTkButton(self,width=900,height=300,text='')
        ...
        # self.search_image_label = tk.CTkLabel(self.content_mivddle, image=self.search_image,fg_color="#096C82", text=' ',corner_radius=100,height=1)
